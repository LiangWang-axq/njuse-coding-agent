...
def tool_schemas() -> list[dict[str, Any]]:
    return [
        {"name": "list_files", "description": "列出工作区内的文件", "parameters": {"path": "相对目录路径，默认 ."}},
        {"name": "read_file", "description": "读取工作区内 UTF-8 文本文件", "parameters": {"path": "相对文件路径"}},
        {"name": "search_code", "description": "在工作区文本文件中搜索字符串", "parameters": {"query": "搜索词", "path": "相对目录或文件路径，默认 ."}},
        {"name": "write_file", "description": "在工作区内创建或完整写入文本文件", "parameters": {"path": "相对文件路径", "content": "完整文件内容"}},
        {"name": "replace_in_file", "description": "按精确文本替换修改文件", "parameters": {"path": "相对文件路径", "old_text": "原文", "new_text": "新文", "expected_count": "期望替换次数，默认 1"}},
        {"name": "run_tests", "description": "在工作区根目录运行受控测试命令", "parameters": {"command": "python -m unittest ... 或 python -m pytest ..."}},
    ]
